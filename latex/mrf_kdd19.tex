...
\title{End-to-end Multi-tasks Recurrent Neural Network and
  Higher-order Markov Random Field Learning For Stock Price
  Prediction}
...
% the page, specified\cite{hu2004} size of margins (2.54cm [1"] top and
...
\bibliography{Bibs/thesis,Bibs/long,Bibs/scene,Bibs/proposal}
