...
% % https://papers.nips.cc/paper/4729-multi-stage-multi-task-feature-learning.pdf

% \textbf{CL comment: This has been done in section 5.2}
...
Our optimization algorithm is summarized in \algref{alg:learning}. As we mentioned
...
CCCP Inner Loop in \algref{alg:learning} is actually solving conventional structural SVM problem.
